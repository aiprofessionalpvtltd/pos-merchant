    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h6 class="m-4"><strong>Name:</strong> {{ $merchant->name }}</h6>
                        <h6 class="m-4"><strong>Surename:</strong> {{ $merchant->surename }}</h6>
                        <h6 class="m-4"><strong>Merchant ID:</strong> {{ $merchant->merchant_id }}</h6>
                        <h6 class="m-4"><strong>Address:</strong> {{ $merchant->address }}</h6>
                        <h6 class="m-4"><strong>Country:</strong> {{ $merchant->country }}</h6>
                        <h6 class="m-4"><strong>City:</strong> {{ $merchant->city }}</h6>
                        <h6 class="m-4"><strong>State:</strong> {{ $merchant->state }}</h6>
                    </div>
                    <div class="col-md-6">
                        <h6 class="m-4"><strong>ICCID Number:</strong> {{ $merchant->iccid_number }}</h6>
                        <h6 class="m-4"><strong>Phone Number:</strong> {{ $merchant->phone_number }}</h6>
                        <h6 class="m-4"><strong>Email:</strong> {{ $merchant->user->email }}</h6>
